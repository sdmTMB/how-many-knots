...
While increasing the resolution of the mesh has been suggested to improve accuracy [@godana_dynamic_2019], other authors have also noted that finer meshes don't always translate into better predictions [@huang_evaluating_2017].
...
We fit all models using R-INLA [@r_core_team_r_2021; @lindgren_bayesian_2015] and R 4.1.0 [@R2021] and specifically the 'inlabru' R package, which is a convenient wrapper for the INLA software [@bachl_inlabru_2019].
